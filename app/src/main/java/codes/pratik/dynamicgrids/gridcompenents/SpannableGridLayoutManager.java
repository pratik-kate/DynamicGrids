...
public class SpannableGridLayoutManager extends GridLayoutManager {
    ...
    public SpannableGridLayoutManager(TwoWayLayoutManager.Orientation orientation, int numColumns, int numRows) {
    ...
    @Override
    public SpannableGridLayoutManager.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new SpannableGridLayoutManager.LayoutParams(c, attrs);
    }
