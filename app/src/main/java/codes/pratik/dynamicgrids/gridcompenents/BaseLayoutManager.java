...
import static codes.pratik.dynamicgrids.gridcompenents.Lanes.calculateLaneSize;
...
import codes.pratik.dynamicgrids.gridcompenents.Lanes.LaneInfo;
...
public abstract class BaseLayoutManager extends TwoWayLayoutManager {
    ...
    protected final Lanes.LaneInfo mTempLaneInfo = new LaneInfo();
    ...
    @Override
    protected void onLayoutScrapList(RecyclerView.Recycler recycler, State state) {
        mLanes.save();
    ...
    protected void layoutChild(View child, Direction direction) {
        ...
        final SpannableGridLayoutManager.LayoutParams lp = (SpannableGridLayoutManager.LayoutParams) child.getLayoutParams();
        if (!lp.isItemRemoved()) {
    ...
    public boolean checkLayoutParams(RecyclerView.LayoutParams lp) {
        if (isVertical()) {
            return (lp.width == SpannableGridLayoutManager.LayoutParams.MATCH_PARENT);
        } else {
            return (lp.height == SpannableGridLayoutManager.LayoutParams.MATCH_PARENT);
        }
    }
