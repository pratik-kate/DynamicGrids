...
import static codes.pratik.dynamicgrids.gridcompenents.TwoWayLayoutManager.Orientation.HORIZONTAL;
import static codes.pratik.dynamicgrids.gridcompenents.TwoWayLayoutManager.Orientation.VERTICAL;
...
//        }
    ...
    public Orientation getOrientation() {
        return (mIsVertical ? VERTICAL : HORIZONTAL);
    }

    public void setOrientation(Orientation orientation) {
        final boolean isVertical = (orientation == VERTICAL);
